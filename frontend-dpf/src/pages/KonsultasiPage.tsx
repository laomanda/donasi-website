...
export function KonsultasiPage() {
  ...
  const validate = () => {
    ...
    else if (!digits.test(form.phone.trim())) next.phone = "konsultasi.form.error.phone.numeric";
          ...
          <div className="grid gap-8 lg:grid-cols-[0.9fr,1.1fr]">
            ...
            <form onSubmit={handleSubmit} className="rounded-[24px] border border-slate-100 bg-white p-8 shadow-[0_22px_70px_-45px_rgba(0,0,0,0.35)] space-y-4">
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <InputField label={t("konsultasi.form.fields.phone")} value={form.phone} onChange={(v) => handleChange("phone", v)} required error={errors.phone ? t(errors.phone) : ""} />
              </div>
              <div className="grid gap-4 sm:grid-cols-2">
