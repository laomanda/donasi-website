          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            {mode === "edit" && publicArticleUrl && form.status === "published" ? (
              <button
                ...
                className="inline-flex items-center gap-2 rounded-2xl border border-brandGreen-200 bg-primary-50 px-5 py-3 text-sm font-bold text-slate-700 shadow-sm transition hover:bg-primary-100 hover:border-brandGreen-300"
              >
            ...
            <button
              type="button"
              onClick={() => openPreview()}
              className="inline-flex items-center gap-2 rounded-2xl border border-slate-200 bg-primary-500 px-5 py-3 text-sm font-bold text-white shadow-sm transition hover:bg-primary-600 disabled:cursor-not-allowed disabled:opacity-70"
