...
export function EditorPartnersPage() {
  ...
  const goEdit = (id: number) => navigate(`/editor/partners/${id}/edit`);
    ...
    <div className="mx-auto w-full max-w-7xl space-y-6">
      <div className="rounded-[28px] border border-primary-100 bg-white p-6 shadow-sm sm:p-8">
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          ...
          <button
            type="button"
            onClick={() => navigate("/editor/partners/create")}
...
export default EditorPartnersPage;
