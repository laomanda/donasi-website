...
export const authDict: Dict = {
    ...
    "register.pic_name_placeholder": { id: "Masukan nama lengkap Anda", en: "Enter your full name" },
    "register.institution_name": { id: "Nama Institusi / Lembaga", en: "Institution Name" },
    "register.institution_name_placeholder": { id: "Nama perusahaan atau yayasan", en: "Company or foundation name" },
