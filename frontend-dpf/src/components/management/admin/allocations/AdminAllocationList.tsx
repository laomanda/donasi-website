              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  {waUrl && (
                    ...
                    >
                      <FontAwesomeIcon icon={faWhatsapp} className="shrink-0" />
              ...
              <div className="flex items-center gap-4 py-4 border-y border-slate-50">
                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-2 mb-0.5">
                    <span className={`inline-flex items-center rounded-md px-2 py-0.5 text-[8px] font-black uppercase tracking-wider text-white shadow-sm ${
                  ...
                  {donorEmail && <p className="text-[11px] font-semibold text-slate-500 truncate">{donorEmail}</p>}
                </div>
              </div>
