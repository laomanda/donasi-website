...
interface AdminAllocationPaginationProps {
  page: number;
  lastPage: number;
  total: number;
  perPage: number;
...
export function AdminAllocationPagination({
  page,
  lastPage,
  loading,
  pageLabel,
  onPageChange,
}: AdminAllocationPaginationProps) {
  return (
...
export default AdminAllocationPagination;
