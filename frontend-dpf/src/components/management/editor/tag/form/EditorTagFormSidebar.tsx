...
export default function EditorTagFormSidebar({ form, onChange, disabled }: Props) {
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
        ...
        <p className="mt-1 text-sm text-slate-500">
          Atur urutan dan visibilitas tag ini.
        </p>
        ...
        <div className="mt-6 space-y-5">
          ...
          <label className="flex items-start gap-3 rounded-2xl border border-slate-200 p-4 transition hover:bg-slate-50 cursor-pointer">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-slate-500 mt-0.5">
                {form.is_active
                  ? "Tag ini dapat dilihat oleh pengunjung website."
                  : "Tag ini disembunyikan sementara."}
              </span>
            </div>
          </label>
          ...
          <label className="flex items-start gap-3 rounded-2xl border border-slate-200 p-4 transition hover:bg-slate-50 cursor-pointer">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-slate-500 mt-0.5">
                Jika diaktifkan, link akan terbuka di tab navigasi baru (target="_blank").
              </span>
            </div>
          </label>
        </div>
